...
async function askUserPermission() {
  // returns default, denied and granted
  return await Notification.requestPermission();
}
//applicationServerKey:
const pushServerPublicKey = "BJU8A-DGZcc06vn4bxD76DtmyQR2JFGEcX1BwSuGQ9c1dd7MZfPBDJR87StNDsGqH7xSyaCS1nTBNHXRfhIj9yo";
const pushServerUrl = `https://push-notification-demo-server.herokuapp.com/subscription`;
/* returns the PushSubscription, an object that contains the unique endpoint for the push server/service,
...
function receivePushNotification(event /*PushEvent*/) {
  ...
  const def = { body: 'notification body', icon: 'avicon', badge: "/favicon.ico", tag: 'notification tag' };
